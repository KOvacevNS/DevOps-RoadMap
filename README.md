...
A collection of hands-on DevOps practice projects based on the official roadmap.sh DevOps challenges.
...
All project definitions and requirements are available on the official  
